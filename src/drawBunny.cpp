...
void createBunnyProgram(vars::Vars&vars){
...
void createBunnyVBO(vars::Vars&vars){
  if(notChanged(vars,"all",__FUNCTION__,{}))return;
...
void drawBunny(vars::Vars&vars,glm::mat4 const&view,glm::mat4 const&proj){
  createBunnyProgram(vars);
  createBunnyVAO(vars);
